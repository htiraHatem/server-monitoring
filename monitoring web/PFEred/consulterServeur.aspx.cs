...
namespace PFEred
{
    public partial class consulterServeur : System.Web.UI.Page
    {
        ...
        public int Bind()
        {
            ...
            cn.Open();
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM serveur", cn);
        ...
        protected void delete_Command1(object sender, CommandEventArgs e)
        {
            ...
            connection.Open();
            SqlCommand command = new SqlCommand("DELETE FROM serveur WHERE codeServeur = " + e.CommandArgument + "", connection);
