...
namespace PFEred.services {
    ...
    public partial class Service1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback wcfMochardOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public Service1() {
            this.Url = global::PFEred.Properties.Settings.Default.PFEred_services_Service1;
        ...
        /// <remarks/>
        public event wcfMochardCompletedEventHandler wcfMochardCompleted;
        ...
        public System.Data.DataSet wcfMailSent(string nom, string prenom, string email, string psk) {
        ...
        /// <remarks/>
        public void wcfMailSentAsync(string nom, string prenom, string email, string psk) {
            this.wcfMailSentAsync(nom, prenom, email, psk, null);
        }
        
        /// <remarks/>
        public void wcfMailSentAsync(string nom, string prenom, string email, string psk, object userState) {
            ...
            this.InvokeAsync("wcfMailSent", new object[] {
                        ...
                        prenom,
                        email,
                        psk}, this.wcfMailSentOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/IService1/wcfMochard", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public bool wcfMochard(int CodeEmploye, string msg) {
            object[] results = this.Invoke("wcfMochard", new object[] {
                        CodeEmploye,
                        msg});
            return ((bool)(results[0]));
        }
        ...
        /// <remarks/>
        public void wcfMochardAsync(int CodeEmploye, string msg) {
            this.wcfMochardAsync(CodeEmploye, msg, null);
        }
        
        /// <remarks/>
        public void wcfMochardAsync(int CodeEmploye, string msg, object userState) {
            if ((this.wcfMochardOperationCompleted == null)) {
                this.wcfMochardOperationCompleted = new System.Threading.SendOrPostCallback(this.OnwcfMochardOperationCompleted);
            }
            this.InvokeAsync("wcfMochard", new object[] {
                        CodeEmploye,
                        msg}, this.wcfMochardOperationCompleted, userState);
        }
        
        private void OnwcfMochardOperationCompleted(object arg) {
            if ((this.wcfMochardCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.wcfMochardCompleted(this, new wcfMochardCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    public delegate void wcfMochardCompletedEventHandler(object sender, wcfMochardCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class wcfMochardCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal wcfMochardCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
