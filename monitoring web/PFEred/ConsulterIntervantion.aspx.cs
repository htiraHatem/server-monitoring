...
namespace PFEred
{
    public partial class ConsulterIntervantion : System.Web.UI.Page
    {
        public object a;
        ...
        public int Bind()
        {
            ...
            cn.Open();
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM intervenir order by codeinter desc", cn);
        ...
        protected void delete_Command1(object sender, CommandEventArgs e)
        {
            ...
            connection.Open();
            SqlCommand command = new SqlCommand("DELETE FROM intervenir WHERE codeinter = " + e.CommandArgument + "", connection);
