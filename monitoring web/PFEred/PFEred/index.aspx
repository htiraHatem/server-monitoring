<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="PFEred.index" %>
...
<body id="skin-blur-violate">
    ...
    <div>
        ...
        <header id="header" class="media">
            ...
            <a class="logo pull-left" href="index-2.html">SUPER ADMIN 1.0</a>
                ...
                <div class="media" id="top-menu">
                    <div class="pull-left tm-icon">
                        <a data-drawer="messages" class="drawer-toggle" href="#">
                            ...
                            <i class="n-count animated">125235</i>
                            <span>Messages</span>
                        </a>
                    </div>
                    <div class="pull-left tm-icon">
