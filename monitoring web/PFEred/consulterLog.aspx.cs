...
namespace PFEred
{
    public partial class consulterLog : System.Web.UI.Page
    {
        public object a;
        ...
        public int Bind()
        {
            ...
            cn.Open();
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM log order by codelog desc", cn);
        ...
        protected void delete_Command1(object sender, CommandEventArgs e)
        {
            ...
            connection.Open();
            SqlCommand command = new SqlCommand("DELETE FROM log WHERE codelog = " + e.CommandArgument + "", connection);
